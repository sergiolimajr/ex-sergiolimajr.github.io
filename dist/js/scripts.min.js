...
=======
function createNode(e){return document.createElement(e)}function append(e,n){return e.appendChild(n)}navigator.serviceWorker&&navigator.serviceWorker.register("/service-worker.js").then(function(e){console.log("ServiceWorker registration successful with scope:",e.scope)}).catch(function(e){console.log("ServiceWorker registration failed:",e)});const divEmergencia=document.getElementById("emergencia"),URL_EMERGENCIA="https://raw.githubusercontent.com/sergiolimajr/projeto-integrador/master/json/emergencia.json";fetch(URL_EMERGENCIA).then(e=>e.json()).then(e=>{return e.services.map(e=>{let n=createNode("div"),t=createNode("a");n.innerHTML=`${t}`,t.innerHTML=`${e.name}`,t.href="../partials/serviceContent.html",t.className="collection-item waves-effect black-text",n.className="collection",append(divEmergencia,n),append(n,t)})}).catch(e=>{console.log("Falha na recuperação de informações",e)});const divUrgencia=document.getElementById("urgencia"),URL_URGENCIA="https://raw.githubusercontent.com/sergiolimajr/projeto-integrador/master/json/urgencia.json";fetch(URL_URGENCIA).then(e=>e.json()).then(e=>{return e.services.map(e=>{let n=createNode("div"),t=createNode("a");n.innerHTML=`${t}`,t.innerHTML=`${e.name}`,t.href="../partials/serviceContent.html",t.className="collection-item waves-effect black-text",n.className="collection",append(divUrgencia,n),append(n,t)})}).catch(e=>{console.log("Falha na recuperação de informações",e)}),$(document).ready(function(){$(".sidenav").sidenav(),$(".tooltipped").tooltip(),$(".dropdown-trigger").dropdown(),$(document).on("pageload",function(){$(".modal-trigger").leanModal({dismissible:!0,opacity:.5,complete:function(){$(document).trigger("modalclose")}})})});
>>>>>>> 3c7c14bb78b8d6807ecc053babbdbaafa2f00e02
=======
>>>>>>> develop
/*!
